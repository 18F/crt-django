...
from .models import WaiverEmailReportCount, AmericaReport

SORT_DESC_CHAR = '-'


def _valid_sort_params(sort):
    valid_fields = [f.name for f in AmericaReport._meta.fields] + [f.name for f in WaiverEmailReportCount._meta.fields]
